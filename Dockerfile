FROM ubuntu:18.04
MAINTAINER Kelvin Koh <koh84@hotmail.com>
...
# Set up locales
RUN apt-get clean && apt-get -y install locales apt-utils sudo && dpkg-reconfigure locales && locale-gen en_US.UTF-8 && update-locale LC_ALL=en_US.UTF-8 LANG=en_US.UTF-8
ENV LANG en_US.utf8
